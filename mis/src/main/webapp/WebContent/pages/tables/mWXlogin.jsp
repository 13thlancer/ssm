            ...
            <ul class="sidebar-menu">
                ...
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="mWXlogin.jsp"><i class="fa fa-circle-o"></i>登录微信</a></li>
            ...
            <div class="box-body">
                <div class="block-content collapse in">
                    ...
                    <div class="container">
                        ...
                        <div class="controls">
                            <button class="btn btn-large btn-primary" type="submit" onclick="Login();return false;">登录</button>
                        </div>
...
<script type="text/javascript">
    function Login() {
        ...
        $.ajax({
            type:"POST",
            url:"<%=basePath%>RequireUserController/checkUser",
            /*cache:false ,*/
            async:false,
            data:postData,
