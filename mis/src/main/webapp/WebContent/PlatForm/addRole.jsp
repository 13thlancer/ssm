                           ...
                           <fieldset>
                               ...
                               <div>
                                   ...
                                   <div style="margin-left:10px;float:left;">
                                       <p>
                                           <input class="vinwi" id="name" type="text" name="name">
                               ...
                               <div>
                                   ...
                                   <div style="margin-left:10px;float:left;">
                                       <p>
                                           <select id="type" class="vinwisel" disabled="disabled">
                                               <option value="user">普通角色</option>
                                               <option value="admin">系统角色</option>
                                           </select>
                                       </p>
                                   </div>
                               </div>
                               ...
                               <div>
                                   ...
                                   <div style="margin-left:10px;float:left;">
                                       <p>
                                           <input  id="companyname" type="text" name="companyname" readonly="readonly" value="金蝶软件武汉分公司">
                                       </p>
                                   </div>
                               </div>
                           </fieldset>
