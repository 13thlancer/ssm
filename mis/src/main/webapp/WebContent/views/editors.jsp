...
<html>
    ...
    <head>
        ...
        <!-- Bootstrap -->
        <link rel="<%=request.getContextPath()%>/WebContent/stylesheet" type="text/css" href="vendors/bootstrap-wysihtml5/src/bootstrap-wysihtml5.css">
    ...
    <div class="container-fluid">
        ...
        <!--/.fluid-container-->
        <script src="<%=request.getContextPath()%>/WebContent/vendors/bootstrap-wysihtml5/lib/js/wysihtml5-0.3.0.js"></script>
		...
		<script src="<%=request.getContextPath()%>/WebContent/vendors/bootstrap-wysihtml5/src/bootstrap-wysihtml5.js"></script>

		<script src="<%=request.getContextPath()%>/WebContent/vendors/ckeditor/ckeditor.js"></script>
		<script src="<%=request.getContextPath()%>/WebContent/vendors/ckeditor/adapters/jquery.js"></script>

		<script type="text/javascript" src="<%=request.getContextPath()%>/WebContent/vendors/tinymce/js/tinymce/tinymce.min.js"></script>
