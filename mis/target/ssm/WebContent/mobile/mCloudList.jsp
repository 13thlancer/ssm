                ...
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="mCloudList.jsp"><i class="fa fa-circle-o"></i>需求订单</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="block-content collapse in">
                    ...
                    <div id="chose" class="container">
                        <h3 class="form-signin-heading"></h3>
                        <div class="control-group">
                            <div class="controls">
                                <select id="type" name="category" style=" height: 30px;padding: 4px 6px;margin-bottom: 10px;font-size: 14px;line-height: 20px;">
                        ...
                        <div class="controls">
                            <button class="btn btn-large btn-primary" type="submit" onclick=" chosetype();return false;">绑定</button>
                        </div>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i = 0;i<length;i++) {
                    $('#orderlist').append('<tr onclick="detail(this);"><td style="display: none">'+data[i].id+'</td><td>'+data[i].username+'</td><td>'+data[i].phone+'</td><td>'+data[i].company+'</td><td>'+data[i].requirename+'</td><td>'+data[i].num+'</td><td>'+data[i].requiretype+'</td><td>'+data[i].requiredate+'</td><td>'+data[i].requirestatus+'</td></tr>');
                }
            }
        });
    }
